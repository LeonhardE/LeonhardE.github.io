  ...
  schools: [
    {
      ...
      descBullets: [
        "GPA: 3.9/4.0",
        "Courses included: Blockchain Technology and Engineering, Introduction to Cloud Computing, Computer Security, Advances in Operating Systems, Quality of Service"
      ]
    },
    {
      ...
      desc: "Major in Software Engineering and Double Degree of Statistics",
  ...
  experience: [
    {
      ...
      desc: "Developed and maintained the Front-end of the company’s main product (2RaceWithMe, which combines physical exercise, virtual touring and presence of family) with JavaScript and Node.js",
      descBullets: [
        ...
        "Modified UI and added additional functions to the application",
        ...
        "Applied the trouble-shooting skills to maintain the software with 200+ videos and fix bugs"
      ]
    },
    {
      ...
      desc: "Worked on the project 'Regional Precipitation Nowcasting' at School of Computer Science and Engineering, Sun Yat-sen University",
      descBullets: [
        "Applied Python(Numpy) to clean the raw meteorological data(2T) which is unable to use directly, and generated a dataset for the optimal model training result",
        "Collaborated with my colleagues to implement and train our new model with Pytorch, and published a research paper as the second author"
      ]
    }
  ]
};
  ...
  projects: [
    {
      ...
      projectDesc: "Independently developed a social media platform with AWS Amplify and React, allowing users to post/manage photos with description and interact (like, comment) with each other",
      footerLink: [
        {
          name: "Visit Website",
    ...
    },
    {
      ...
      projectDesc: "Implemented a DApp called Meetup with Truffle and React, allowing users to earn profit by creating and attending events, and use the token to trade in the embedded NFT market",
      footerLink: [
        {
